    ...
    private  void createAccount(String semail,String scon_password,String sname)
    {
        ...
        mAuth.createUserWithEmailAndPassword(semail,scon_password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                {
                    Database.StoreData(semail,sname, new MycompleteListener() {
                        @Override
                        public void OnSuccess() {
                            Database.Loadcat(new MycompleteListener() {
                                ...
                                public void OnSuccess() {
                                    ...
                                    Toast.makeText(RegisterActivity.this, "Account  created sucessfulliy", Toast.LENGTH_SHORT).show();
                                ...
                                public void OnFailure() {
                                    progess_dailog.dismiss();
                                    Toast.makeText(RegisterActivity.this, "Login Fail", Toast.LENGTH_SHORT).show();
                                }
                            });
