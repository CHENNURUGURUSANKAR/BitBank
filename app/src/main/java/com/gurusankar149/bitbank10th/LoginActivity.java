                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            if (task.getResult().getAdditionalUserInfo().isNewUser()) {
                                ...
                                Database.StoreData(user.getEmail(), user.getDisplayName(), new MycompleteListener() {
                                    @Override
                                    public void OnSuccess() {
                                        Database.Loadcat(new MycompleteListener() {
                                            @Override
                                            ...
                                            public void OnFailure() {
                                                progess_dailog.dismiss();
                                                Toast.makeText(LoginActivity.this, "Login Fail Something went Worng", Toast.LENGTH_SHORT).show();
